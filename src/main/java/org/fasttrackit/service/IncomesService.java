...
public class IncomesService {
    ...
    public void createIncome(CreateIncomeRequest request) throws IOException, SQLException {
        System.out.println("Creating income: " + request);

        incomeRepository.createTask(request);
    }

    public void updateIncome (long id, UpdateIncomeRequest request) throws IOException, SQLException {
        System.out.println("Updating income: " + id);
        incomeRepository.updateTask(id, request);
    }

    public void deleteIncome (long id) throws IOException, SQLException {
        System.out.println("Deleting income: " + id);
        incomeRepository.deleteTask(id);
    }

    public List<Incomes> getIncomes() throws IOException, SQLException {
